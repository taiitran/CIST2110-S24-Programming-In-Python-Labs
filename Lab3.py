...
# 4. Ask the user for a number of years to calculate interest and assign it to a variable
#  called "years".
years = input("How many years would you like to calculate interest for? ")
...
future_balance = float(balance) * (1 + float(interest_rate)/100) ** years
