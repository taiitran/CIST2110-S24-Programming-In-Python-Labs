...
def test_grade_calculator():
    ...
    assert (
        grade_calculator(105) == "Invalid Score"
    ), "Grade calculation failed for out-of-range score"
    assert (
        grade_calculator(-5) == "Invalid Score"
    ), "Grade calculation failed for negative score"
